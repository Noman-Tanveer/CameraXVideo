...
public final class FragmentCaptureBinding implements ViewBinding {
  ...
  private FragmentCaptureBinding(@NonNull ConstraintLayout rootView,
      ...
      @Nullable ImageButton settingsButton, @NonNull ImageButton stopButton,
      @Nullable Guideline verticalGuideline) {
  ...
  public static FragmentCaptureBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentCaptureBinding((ConstraintLayout) rootView, audioSelection, cameraButton,
          ...
          landVerticalGuideline, previewView, qualitySelection, settingsButton, stopButton,
          verticalGuideline);
    }
